...
bool test_memfile_get_rest_of_line(const std::string& name);
...
bool test_memfile_write_double_quotes(const std::string& name, int qty, bool enable_quote);
...
int main()
{
	...
	test_memfile("test_memfile3.txt", "Fruits, Vegetable", 300, true);
	test_memfile("test_memfile4.txt", "Fruits", 400, false);
	test_memfile("test_memfile5.txt", "", 500, false);
	...
	test_memfile_write_double_quotes("He said: \"the more, the merrier\"", 66, true);

	test_get_rest_of_line("Fruits");
	test_file_get_rest_of_line("Fruits");
	test_memfile_get_rest_of_line("Fruits");
...
bool test_memfile(const std::string& file, const std::string& name, int qty, bool enable_quote)
{
	...
	os.write_to_file(file.c_str());

	csv::icachedfstream is(file);
	is.set_delimiter(',', "$$");
	is.enable_trim_quote_on_str(enable_quote, '\"');
...
bool test_memfile_get_rest_of_line(const std::string& name)
{
	...
	os.write_to_file("test_memfile_get_rest_of_line.txt");

	csv::icachedfstream is("test_memfile_get_rest_of_line.txt");
...
bool test_memfile_write_double_quotes(const std::string& name, int qty, bool enable_quote)
{
	...
	os.write_to_file("test_memfile_write_double_quotes.txt");

	csv::icachedfstream is("test_memfile_write_double_quotes.txt");
	is.set_delimiter(',', "$$");
	is.enable_trim_quote_on_str(enable_quote, '\"');
