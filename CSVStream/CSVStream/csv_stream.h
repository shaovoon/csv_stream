// The MIT License (MIT)
// capi Fast CSV Streams 0.5.5b Beta
...
// version 0.5.5b : Set visibility of some methods of istream_base from protected to public
...
namespace capi
{
	namespace csv
	{
		...
		public:
			...
			{
				std::string error = "csv::istream_base conversion error at line no.:";
...
namespace capi
{
	namespace csv
	{
		...
		class icachedfstream : public istream_base
		{
		public:
		...
		class ocachedfstream : public ostream_base
		{
		public:
